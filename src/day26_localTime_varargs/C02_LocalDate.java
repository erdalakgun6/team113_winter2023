...
public class C02_LocalDate {
    public static void main(String[] args) {
        ...
        System.out.println(tarih); // 2023-03-12

        System.out.println(tarih.isLeapYear()); // false
        LocalDate tarih2 = LocalDate.of(2020,10,10);
        System.out.println(tarih2.isLeapYear());
        System.out.println(tarih.plusWeeks(20).plusDays(2)); // 2023-08-01
        System.out.println(tarih.minusMonths(3).minusDays(3)); // 2022-12-09
        System.out.println(tarih.withYear(1923).withMonth(5)); // 1923-05-12
        System.out.println(tarih.getDayOfYear()); // 71
